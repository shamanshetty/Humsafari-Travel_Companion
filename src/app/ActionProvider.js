...
class ActionProvider {
    ...
    callGenAI = async (prompt) => {
        const chatCompletion = await openAI.chat.completions.create({
            model: "gpt-3.5-turbo",
            messages: [
                {role:"system", content: "You are a friendly and knowledgeable travel planner chatbot. Your goal is to help users plan their trips by providing personalized recommendations, itineraries, and travel tips. "},
